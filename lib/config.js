...
// Bump when scan result or cache format changes in a breaking way.
// Mismatched versions cause in-memory results to be discarded and the file cache to be rebuilt.
